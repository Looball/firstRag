...
| `PLAN-20260802-01` | 2026-08-02 | `Doing` | 在保留完整可运行实现的前提下，将 `main` 单主线转为分层教程与工程参考实现，并停止非必要功能扩展。 | `T-122` - `T-129` |
...
| `T-129` | `PLAN-20260802-01` | `P1` | `Doing` | 明确教程仓库 License 与公开使用边界 | 2026-08-03 | — |
