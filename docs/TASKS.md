...
| `PLAN-20260731-08` | 2026-07-31 | `Doing` | 继续拆分聊天提交 hook，独立管理 SSE 请求、assistant 回写与 diagnostics preload。 | `T-117` |
...
| `T-117` | `PLAN-20260731-08` | `P1` | `Doing` | 抽取 chat response stream hook | - | - |
