...
PDF_OCR_REINDEX_MAX_BATCH_PAGES = read_int_env(
    "PDF_OCR_REINDEX_MAX_BATCH_PAGES",
    20,
)
PDF_OCR_HISTORY_MAX_RUNS_PER_PAGE = read_int_env(
    "PDF_OCR_HISTORY_MAX_RUNS_PER_PAGE",
    20,
)
PDF_OCR_ADAPTIVE_REINDEX_ENABLED = read_bool_env(
    "PDF_OCR_ADAPTIVE_REINDEX_ENABLED",
    True,
)
PDF_OCR_ADAPTIVE_MAX_CANDIDATES = read_int_env(
    "PDF_OCR_ADAPTIVE_MAX_CANDIDATES",
    6,
)
PDF_OCR_ADAPTIVE_TIMEOUT_SECONDS = read_int_env(
    "PDF_OCR_ADAPTIVE_TIMEOUT_SECONDS",
    120,
)
PDF_OCR_BINARY_THRESHOLD = read_int_env(
...
SPARSE_ENCODER_CLIENT_BATCH_SIZE = read_int_env(
